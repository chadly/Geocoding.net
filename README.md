#Generic C# Geocoding API [![Build Status](http://chadly.net/builds/app/rest/builds/buildType:(id:GeocodingNe_Build)/statusIcon)](http://chadly.net/builds/viewType.html?buildTypeId=GeocodingNe_Build&guest=1)
