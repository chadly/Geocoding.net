...
namespace GeoCoding.Services.VirtualEarth.Token {
    ...
    public interface CommonServiceSoap {
        ...
        GeoCoding.Services.VirtualEarth.Token.GetVersionInfoResponse GetVersionInfo(GeoCoding.Services.VirtualEarth.Token.GetVersionInfoRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoResponse GetCountryRegionInfo(GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        GeoCoding.Services.VirtualEarth.Token.GetEntityTypesResponse GetEntityTypes(GeoCoding.Services.VirtualEarth.Token.GetEntityTypesRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoResponse GetDataSourceInfo(GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesResponse GetGreatCircleDistances(GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        GeoCoding.Services.VirtualEarth.Token.GetClientTokenResponse GetClientToken(GeoCoding.Services.VirtualEarth.Token.GetClientTokenRequest request);
    }
    ...
    public partial class GetVersionInfoRequest {
        ...
        public GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader;
        
        [System.ServiceModel.MessageHeaderAttribute(Namespace="http://s.mappoint.net/mappoint-30/")]
        public GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader;
        
        public GetVersionInfoRequest() {
        }
        
        public GetVersionInfoRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader) {
    ...
    public partial class GetCountryRegionInfoRequest {
        ...
        public GetCountryRegionInfoRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, int[] entityIDs) {
            this.CustomerInfoHeader = CustomerInfoHeader;
            this.UserInfoHeader = UserInfoHeader;
    ...
    public partial class GetEntityTypesRequest {
        ...
        public GetEntityTypesRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, string dataSourceName) {
            this.CustomerInfoHeader = CustomerInfoHeader;
            this.UserInfoHeader = UserInfoHeader;
    ...
    public partial class GetDataSourceInfoRequest {
        ...
        public GetDataSourceInfoRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, string[] dataSourceNames) {
            this.CustomerInfoHeader = CustomerInfoHeader;
            this.UserInfoHeader = UserInfoHeader;
    ...
    public partial class GetGreatCircleDistancesRequest {
        ...
        public GetGreatCircleDistancesRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, LatLong[] latLongs) {
            this.CustomerInfoHeader = CustomerInfoHeader;
            this.UserInfoHeader = UserInfoHeader;
    ...
    public partial class GetClientTokenRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://s.mappoint.net/mappoint-30/", Order=0)]
        public GeoCoding.Services.VirtualEarth.Token.TokenSpecification specification;
        
        public GetClientTokenRequest() {
        }
        
        public GetClientTokenRequest(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, GeoCoding.Services.VirtualEarth.Token.TokenSpecification specification) {
            this.CustomerInfoHeader = CustomerInfoHeader;
            this.UserInfoHeader = UserInfoHeader;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface CommonServiceSoapChannel : GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class CommonServiceSoapClient : System.ServiceModel.ClientBase<GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap>, GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap {
        ...
        GeoCoding.Services.VirtualEarth.Token.GetVersionInfoResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetVersionInfo(GeoCoding.Services.VirtualEarth.Token.GetVersionInfoRequest request) {
            return base.Channel.GetVersionInfo(request);
        }
        
        public VersionInfo[] GetVersionInfo(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader) {
            GeoCoding.Services.VirtualEarth.Token.GetVersionInfoRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetVersionInfoRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            GeoCoding.Services.VirtualEarth.Token.GetVersionInfoResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetVersionInfo(inValue);
            return retVal.GetVersionInfoResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetCountryRegionInfo(GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoRequest request) {
            return base.Channel.GetCountryRegionInfo(request);
        }
        
        public CountryRegionInfo[] GetCountryRegionInfo(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, int[] entityIDs) {
            GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            inValue.entityIDs = entityIDs;
            GeoCoding.Services.VirtualEarth.Token.GetCountryRegionInfoResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetCountryRegionInfo(inValue);
            return retVal.GetCountryRegionInfoResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        GeoCoding.Services.VirtualEarth.Token.GetEntityTypesResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetEntityTypes(GeoCoding.Services.VirtualEarth.Token.GetEntityTypesRequest request) {
            return base.Channel.GetEntityTypes(request);
        }
        
        public EntityType[] GetEntityTypes(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, string dataSourceName) {
            GeoCoding.Services.VirtualEarth.Token.GetEntityTypesRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetEntityTypesRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            inValue.dataSourceName = dataSourceName;
            GeoCoding.Services.VirtualEarth.Token.GetEntityTypesResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetEntityTypes(inValue);
            return retVal.GetEntityTypesResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetDataSourceInfo(GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoRequest request) {
            return base.Channel.GetDataSourceInfo(request);
        }
        
        public DataSource[] GetDataSourceInfo(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, string[] dataSourceNames) {
            GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            inValue.dataSourceNames = dataSourceNames;
            GeoCoding.Services.VirtualEarth.Token.GetDataSourceInfoResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetDataSourceInfo(inValue);
            return retVal.GetDataSourceInfoResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetGreatCircleDistances(GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesRequest request) {
            return base.Channel.GetGreatCircleDistances(request);
        }
        
        public double[] GetGreatCircleDistances(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, LatLong[] latLongs) {
            GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            inValue.latLongs = latLongs;
            GeoCoding.Services.VirtualEarth.Token.GetGreatCircleDistancesResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetGreatCircleDistances(inValue);
            return retVal.GetGreatCircleDistancesResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        GeoCoding.Services.VirtualEarth.Token.GetClientTokenResponse GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap.GetClientToken(GeoCoding.Services.VirtualEarth.Token.GetClientTokenRequest request) {
            return base.Channel.GetClientToken(request);
        }
        
        public string GetClientToken(GeoCoding.Services.VirtualEarth.Token.CustomerInfoHeader CustomerInfoHeader, GeoCoding.Services.VirtualEarth.Token.UserInfoHeader UserInfoHeader, GeoCoding.Services.VirtualEarth.Token.TokenSpecification specification) {
            GeoCoding.Services.VirtualEarth.Token.GetClientTokenRequest inValue = new GeoCoding.Services.VirtualEarth.Token.GetClientTokenRequest();
            inValue.CustomerInfoHeader = CustomerInfoHeader;
            inValue.UserInfoHeader = UserInfoHeader;
            inValue.specification = specification;
            GeoCoding.Services.VirtualEarth.Token.GetClientTokenResponse retVal = ((GeoCoding.Services.VirtualEarth.Token.CommonServiceSoap)(this)).GetClientToken(inValue);
